...
internal data class KnitPatternEntity(@PrimaryKey val name: String, val currentRow: Int, val nextStitchInRow: Int, val stitchesFilePath: String, val thumbnailFilePath: String) {
